...
let players = [];               // Players DB (62 players)
...
function initApp() {
  ...
  // Clone Players from configuration (62 players total)
...
function resetEntireAuction() {
  if (!confirm("Caution! Are you completely sure you want to restore the auction database? All franchise budgets will restore to 1,00,000 POINTS, all rosters will clear, and all 62 players will be returned to the available draw pool.")) {
    return;
  }
